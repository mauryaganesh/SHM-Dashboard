...
FROM ISL204 WHERE TimeStamp > "2020-02-17 10:00:00"
';
            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        ...
                        <li class="active"><a href="isl204.php"><i class="ti-bar-chart-alt"></i>  ISL204  </a>
                ...
                <div class="container-fluid">
                    ...
                    <section id="main-content">
                        ...
                        <div class="row">
                            <!-- column -->
                            <div class="col-lg-12">
                              <h5  class="style-h5">Online Structural Health Monitoring For ISL204 Room at CSIR-CEERI, Pilani</h5>
                                <!--<div class="card">
                                    <div class="card-body">
