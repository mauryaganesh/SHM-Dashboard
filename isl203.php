...
FROM ISL203 WHERE TimeStamp > "2020-02-17 10:00:00"
';
            ...
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        ...
                        <li class=""><a href="isl202.php"><i class="ti-bar-chart-alt"></i>  ISL202  </a>
                        <li class="active"><a href="isl203.php"><i class="ti-bar-chart-alt"></i>  ISL203  </a>
                ...
                <div class="container-fluid">
                    ...
                    <section id="main-content">
                        ...
                        <div class="row">
                            <!-- column -->
                            <div class="col-lg-12">
                              <h5  class="style-h5">Online Structural Health Monitoring For ISL203 Room at CSIR-CEERI, Pilani</h5>
                                <!--<div class="card">
                                    <div class="card-body">
