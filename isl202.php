...
FROM ISL202 WHERE TimeStamp > "2020-02-17 10:00:00"
';
        ...
        <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
            <div class="nano">
                <div class="nano-content">
                    ...
                    <ul>
                        <li class="" ><a href="index.php"><i class="ti-home"></i> Online Dashboard</a></li>

                        <li class="label">Room Sections</li>
                        <li class=""><a href="isl201.php"><i class="ti-bar-chart-alt"></i>  ISL201  </a>
                        <li class="active"><a href="isl202.php"><i class="ti-bar-chart-alt"></i>  ISL202  </a>
                        <li class=""><a href="isl203.php"><i class="ti-bar-chart-alt"></i>  ISL203  </a>
                        <li class=""><a href="isl204.php"><i class="ti-bar-chart-alt"></i>  ISL204  </a>
                        <!--<li class=""><a><i class="ti-bar-chart-alt"></i>  About </a> -->
                            <!--<ul>
                ...
                <div class="container-fluid">
                    ...
                    <section id="main-content">
                        ...
                        <div class="row">
                            <!-- column -->
                            <div class="col-lg-12">
                              <h5  class="style-h5">Online Structural Health Monitoring For ISL202 Room at CSIR-CEERI, Pilani</h5>
                                <!--<div class="card">
                                    <div class="card-body">
